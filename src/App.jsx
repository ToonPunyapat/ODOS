...
function App() {
  ...
  return (
    <div className="Sukhumvit">
      <Navbar />
      <div
        className="grid grid-rows-8 md:grid-rows-none md:grid-cols-1"
        style={{
          gridTemplateRows:
            window.innerWidth <= 640
              ? "737px 600px 400px auto 20px auto 450px 350px"
              : "737px 600px 400px auto 20px auto 450px 350px",
        }}
      >
        <div className="flex flex-col justify-center items-center bg-cover bg-center bg-[url('/images/fc0003_40702826139d468fbc3f3271bd57352d~mv2.avif')]">
          <p className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#FFF200] mb-2 text-center">
            หนึ่งอำเภอหนึ่งทุน{" "}
            <span className="block sm:inline">ซัมเมอร์แคมป์</span>
          </p>
          ...
          <p className="text-lg md:text-2xl lg:text-3xl max-w-md md:max-w-lg lg:max-w-4xl leading-relaxed mt-7 text-white mb-10 text-left indent-8 px-4">
            โครงการ “หนึ่งอำเภอ หนึ่งทุน Summer Camp”
            เพื่อสร้างโอกาสทางการศึกษาที่เท่าเทียมกันให้แก่เยาวชนไทยทุกคน
            จากทุกอำเภอ ทั่วประเทศไทย โดยเฉพาะในพื้นที่ห่างไกล
            รวมถึงกรุงเทพมหานคร
            ผ่านการมอบทุนการศึกษาเพื่อไปศึกษาเรียนรู้เทคโนโลยีดิจิทัลที่ทันสมัยในต่างประเทศ
            พร้อมทั้งเปิดประสบการณ์ในการทำงานจริงในบริษัทชั้นนำระดับโลก
            และเยี่ยมชมบริษัทเทคโนโลยีชั้นนำในต่างประเทศ
            เพื่อให้เยาวชนเหล่านี้ได้มีทักษะดิจิทัล
            ตลอดสามารถนำความรู้และทักษะที่ได้รับกลับมาพัฒนาประเทศ
          </p>
        </div>
        ...
        <div className="h-full w-full">
          <div className="hidden sm:block md:block lg:block">
            <img src="/images/messageImage_1736408704793.jpg" alt="" />
          </div>
          <div className="sm:hidden">
            <img src="/images/export (2)_0.png" alt="" />
          </div>
        </div>
        <div className="bg-[#0B293B]"></div>
        <div className="h-full w-full">
          <div className="hidden sm:block md:block lg:block">
            <img src="/images/messageImage_1736408714509.jpg" alt="" />
          </div>
          <div className="sm:hidden">
            <img src="/images/export (3)_0.png" alt="" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 bg-[#FFF200]">
          <div className="grid justify-items-start place-content-center px-4 py-6">
            ...
            <div className="text-md">
              <p>เว็บไซต์นี้สร้างโดย สำนักงานส่งเสริมเศรษฐกิจดิจิทัล</p>
              <p>Email: depathailand@depa.or.th</p>
              <p>ที่ตั้ง: 234/431 ถนนลาดพร้าว ซอยลาดพร้าว 10 </p>
              <p>แขวงจอมพล เขตจตุจักร กรุงเทพมหานคร 10900 </p>
            </div>
          </div>
        </div>
      </div>
