  ...
  return (
    <div>
      <p className="text-3xl md:text-5xl lg:text-6xl font-bold text-center">
        <span className="text-[#869bd4]">ODOS </span>
        <span className="text-[black]">: </span>
        <span className="text-[black]">Summer Camp</span>
      </p>
      <p className="text-[black] text-lg text-justify md:text-2xl lg:text-3xl max-w-md md:max-w-lg lg:max-w-4xl leading-relaxed mt-7 mb-10 text-left indent-8 px-4">
