...
function Highlight() {
  return (
    <div className="flex flex-col items-center">
      <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-[red]">
        Inspiring Youth,
      </p>
      <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-center text-[red]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 mt-10 max-w-4xl mx-auto">
        <div className="flex flex-col items-center">
          ...
          <p className="text-[black] dark:text-[white] mt-2 text-center text-lg font-semibold md:text-xl lg:text-2xl mb-4">
            Youth
          </p>
          <p className="text-sm dark:text-[white] lg:text-lg text-center max-w-52">
            Foster hands-on, inclusive, and equitable learning opportunities
          </p>
          <br />
          <p className="text-sm dark:text-[white] mt-5 lg:text-lg text-center max-w-60">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm dark:text-[white] lg:text-lg text-center max-w-72">
            Strengthen diplomatic ties, connecting global tech companies, global
            universities, and Thailand
          </p>
          <br />
          <p className="text-sm dark:text-[white] mt-5 lg:text-lg text-center max-w-72">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm dark:text-[white] lg:text-lg text-center max-w-60">
            Develop innovative education models that ensure equal and widespread
            opportunities across all areas
          </p>
          <p className="text-sm dark:text-[white] mt-5 lg:text-lg text-center max-w-64">
