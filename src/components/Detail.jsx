  ...
  return (
    <div>
      <div className="flex flex-col items-center place-content-center text-center py-10 sm:py-12 md:py-16 px-4 h-full">
        <p className="text-3xl sm:text-4xl md:text-5xl text-[red] font-bold">
          Project details
        </p>
        <p className="text-sm text-justify sm:text-base md:text-lg text-black dark:text-white text-left mt-6 sm:mt-8 md:mt-10 max-w-md sm:max-w-lg md:max-w-2xl leading-relaxed indent-8">
